...
| **Indicator colour scheme**  | `random` preserves the existing mixed colours. Other schemes map oldest to newest revisions: red to green, or white fading to blue, sky blue, teal, violet, orange, or vermilion. | `random`      |
