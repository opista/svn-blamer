...
suite("Truncate String Test Suite", () => {
    ...
    test("should return original string if length is exactly 20", () => {
        const str = "12345678901234567890";
        assert.strictEqual(truncateString(str), str);
    });

    test("should return original string if length is less than 20", () => {
    ...
    test("should trim whitespace before appending ellipsis", () => {
        const str = "1234567890123456    1234";
        assert.strictEqual(truncateString(str), "1234567890123456...");
    });
});
